...
h5=(TH1F*)matched_DRfraction_inB->Clone();
h5->Rebin(r2);
TH1F *h5b = new TH1F("h5b","5b",100,0,1.);
h5b=(TH1F*)h5->Clone();
TH1F *h6 = new TH1F("h6","6",100,0,1.);
h6=(TH1F*)single_matched_DRfraction_inB->Clone();
h6->Rebin(r2);
h5->Add(h6,-1);
h5->Divide(h5b);
h5->SetTitle("(matched-singlematched)/matched_vs_DR_trk");
h5->GetXaxis()->SetTitle("DR_trk");
...
h8->Rebin(r2);
h7->Divide(h8);
h7->SetTitle("singlematched/matched_vs_DR_trk");
h7->GetXaxis()->SetTitle("DR_trk");
